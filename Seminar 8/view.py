...
def add_employees():
    print("Введите данные сотрудника (фамилию, имя, телефон и должность) через пробел:")
    data = input().split()
    return data
...
def change_employees():
    ...
    change = int(input())
    print("Введите новые данные сотрудника (фамилию, имя, телефон и должность) для перезаписи через пробел:")
    string = input().split()
